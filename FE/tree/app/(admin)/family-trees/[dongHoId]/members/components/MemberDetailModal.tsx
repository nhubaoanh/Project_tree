    ...
    return (
      <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 animate-fadeIn">
        <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl">
          {/* Header với ảnh */}
          <div className="relative bg-gradient-to-br from-red-900 via-red-700 to-yellow-600 p-6 text-white">
            <button
              onClick={onClose}
                ...
                <p className="text-white/80 flex items-center gap-2 mt-1">
                  <span
                    className={`px-2 py-0.5 rounded text-xs font-semibold ${
                      member.gioiTinh === 1 ? "bg-blue-500" : "bg-pink-500"
                    }`}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <InfoRow
                  ...
                  label="Ngày mất"
                  value={
                    member.ngayMat ? formatDate(member.ngayMat) : "Còn sống"
                  }
                />
                <InfoRow
                  icon={MapPin}
              ...
              <div className="space-y-1">
                ...
                <InfoRow
                  ...
                  value={member.trinhDoHocVan}
                />
                <InfoRow
                  icon={Home}
                  label="Địa chỉ hiện tại"
                  value={member.diaChiHienTai}
                />
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-[#fdf6e3] rounded-lg p-3 text-center">
                  ...
                  <p className="text-sm font-semibold text-[#5d4037]">
                    {(member as any).tenCha || `ID: ${member.chaId || "-"}`}
                  </p>
                </div>
                <div className="bg-[#fdf6e3] rounded-lg p-3 text-center">
                  <Users size={20} className="mx-auto text-[#d4af37] mb-1" />
          ...
          <div className="p-4 border-t border-[#e8dcc8] bg-[#fdf6e3]">
            <button
              onClick={onClose}
              className="w-full py-2 bg-[#5d4037] text-white rounded-lg hover:bg-[#4a3228] transition-colors font-semibold"
            >
              Đóng
            </button>
          </div>
